...
## Decision
Implement Type3arabi as a TSF Text Input Processor (in-proc COM DLL) registered under Arabic LANGIDs (amended by ADR-0009: exactly one, ar-SA), with composition, candidate UI, UILess support, input-mode compartment and tray mode icon.
